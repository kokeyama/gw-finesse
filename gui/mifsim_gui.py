...
kFPMI_sec_sw_dmod1_setting = [
            ...
            [sg.Checkbox('I_arbitraryfreq001',        key='kFPMI_pd1_Iphase_arbitraryfreq001'), 
             ...
             sg.Text('arbitraryfreq001 = '), sg.Input(key='kFPMI_arbitraryfreq001',        default_text='2*16.881M', enable_events=True),
             sg.Text('label name = '),       sg.Input(key='kFPMI_arbitraryfreq001_name',   default_text='2f1',    enable_events=True)],
            [sg.Checkbox('I_arbitraryfreq002',        key='kFPMI_pd1_Iphase_arbitraryfreq002'), 
             ...
             sg.Text('arbitraryfreq002 = '), sg.Input(key='kFPMI_arbitraryfreq002',        default_text='3*16.881M', enable_events=True),
             sg.Text('label name = '),       sg.Input(key='kFPMI_arbitraryfreq002_name',   default_text='3f1',    enable_events=True)],
            [sg.Text('note:')],
...
kPRFPMI_sec_sw_dmod1_setting = [
            ...
            [sg.Checkbox('I_arbitraryfreq001',        key='kPRFPMI_pd1_Iphase_arbitraryfreq001'), 
             ...
             sg.Text('arbitraryfreq001 = '), sg.Input(key='kPRFPMI_arbitraryfreq001',        default_text='2*16.881M', enable_events=True),
             sg.Text('label name = '),       sg.Input(key='kPRFPMI_arbitraryfreq001_name',   default_text='2f1',    enable_events=True)],
            [sg.Checkbox('I_arbitraryfreq002',        key='kPRFPMI_pd1_Iphase_arbitraryfreq002'), 
             ...
             sg.Text('arbitraryfreq002 = '), sg.Input(key='kPRFPMI_arbitraryfreq002',        default_text='3*16.881M', enable_events=True),
             sg.Text('label name = '),       sg.Input(key='kPRFPMI_arbitraryfreq002_name',   default_text='3f1',    enable_events=True)],
            [sg.Text('note:')],
            [sg.Text('You can set the number of sidebands generated by the modulator in the OPTION tab(default num 1),')],
            [sg.Text('so if you want to demodulate at a frequency such as 2f1 or 3f1, increase the number of sidebands.')],
...
kDRFPMI_sec_sw_dmod1_setting = [
            ...
            [sg.Checkbox('I_arbitraryfreq001',        key='kDRFPMI_pd1_Iphase_arbitraryfreq001'), 
             ...
             sg.Text('arbitraryfreq001 = '), sg.Input(key='kDRFPMI_arbitraryfreq001',        default_text='2*16.881M', enable_events=True),
             sg.Text('label name = '),       sg.Input(key='kDRFPMI_arbitraryfreq001_name',   default_text='2f1',    enable_events=True)],
            [sg.Checkbox('I_arbitraryfreq002',        key='kDRFPMI_pd1_Iphase_arbitraryfreq002'), 
             ...
             sg.Text('arbitraryfreq002 = '), sg.Input(key='kDRFPMI_arbitraryfreq002',        default_text='3*16.881M', enable_events=True),
             sg.Text('label name = '),       sg.Input(key='kDRFPMI_arbitraryfreq002_name',   default_text='3f1',    enable_events=True)],
            [sg.Text('note:')],
            [sg.Text('You can set the number of sidebands generated by the modulator in the OPTION tab(default num 1),')],
            [sg.Text('so if you want to demodulate at a frequency such as 2f1 or 3f1, increase the number of sidebands.')],
...
kMI_sec_sw_dmod1_setting = [
            ...
            [sg.Checkbox('I_arbitraryfreq001',        key='kMI_pd1_Iphase_arbitraryfreq001'), 
             ...
             sg.Text('arbitraryfreq001 = '), sg.Input(key='kMI_arbitraryfreq001',        default_text='2*16.881M', enable_events=True),
             sg.Text('label name = '),       sg.Input(key='kMI_arbitraryfreq001_name',   default_text='2f1',    enable_events=True)],
            [sg.Checkbox('I_arbitraryfreq002',        key='kMI_pd1_Iphase_arbitraryfreq002'), 
             ...
             sg.Text('arbitraryfreq002 = '), sg.Input(key='kMI_arbitraryfreq002',        default_text='3*16.881M', enable_events=True),
             sg.Text('label name = '),       sg.Input(key='kMI_arbitraryfreq002_name',   default_text='3f1',    enable_events=True)],
            [sg.Text('note:')],
            [sg.Text('You can set the number of sidebands generated by the modulator in the OPTION tab(default num 1),')],
            [sg.Text('so if you want to demodulate at a frequency such as 2f1 or 3f1, increase the number of sidebands.')],
            ...
            if is_overplot_all_pds: # 全部overplotするとき
                ...
                for port in port_trues:
                    for pdname_tail in pdname_tails:
                        ...
                        pdnames.append(pdname)
                        label  = make_pd1_label(pdname,dic_selected_setting_from_gui["arbitraryfreq001_name"],dic_selected_setting_from_gui["arbitraryfreq002_name"])
                        plt.plot(out.x, out['%s' % pdname], label=label)
                        plt.xscale(x_plotscale)
                        plt.yscale(y_plotscale)
                        plt.xlabel(out.xlabel.split()[0]+out.xlabel.split()[1], fontsize=18)
                        plt.ylabel("Demodulated signal[a.u.]", fontsize=18)
                        plt.title('%s' % plot_title, fontsize=18)
                        plt.tick_params(labelsize=18)
                        # 凡例の表示
                        plt.legend(fontsize=18) 
